                        ...
                        <div>
                            ...
                            <div className="relative mt-2">
                                <div className="absolute inset-y-0 left-3 my-auto h-6 flex items-center border-r pr-2">
                                    <select className="text-sm bg-transparent outline-none h-full">
                                        <option>GH</option>
                                        <option>US</option>
                                        <option>UK</option>
                                    </select>
                                ...
                                <input
                                    type="number"
                                    placeholder="0547 000 000"
                                    required
                                    className="w-full pl-[4.5rem] pr-3 py-2 appearance-none bg-transparent outline-none border focus:border-black shadow-sm"
                                />
                            </div>
                        </div>
                        <div>
